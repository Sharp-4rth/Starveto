...
from wtforms import SubmitField, StringField, HiddenField, RadioField, PasswordField, BooleanField, TextAreaField
from wtforms.validators import DataRequired, ValidationError, Email, EqualTo
from app import db
from app.models import User

class PostcodeForm(FlaskForm):
    postcode = HiddenField('Postcode', validators=[DataRequired()])
...
class ChangeEmailForm(FlaskForm):
    ...
    confirm = StringField('Confirm New Email', validators=[DataRequired(), EqualTo('new_email', message="Emails must match")])
